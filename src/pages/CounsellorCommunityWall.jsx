      ...
      <div className="ml-64 flex-1 flex flex-col">
        ...
        <div className="p-8">
          ...
          <div className="flex gap-6">
            {/* Community Wall */}
            <div className="flex-1 bg-green-900 text-white p-6 rounded-3xl shadow-md flex flex-col">
              {/* Posts Area */}
              <div className="flex-1 overflow-y-auto space-y-4 mb-4 pr-2">
                {posts.length === 0 ? (
                  ...
                  posts.map((post, idx) => (
                    <div
                      key={idx}
                      className="flex items-start gap-3 bg-white text-green-900 p-4 rounded-xl shadow-sm"
                    >
                      {/* Placeholder Avatar */}
                      <UserCircle size={36} className="text-green-700 shrink-0" />
              ...
              <div className="flex items-center gap-3">
                <UserCircle size={40} className="text-white shrink-0" />
                <input
                  type="text"
                  value={message}
