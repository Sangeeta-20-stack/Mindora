        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-green-900 text-white p-6 rounded-2xl shadow-lg text-center">
              ...
              <p className="mt-2 text-sm">{t("shortDetails")}</p>
            </div>
            ...
            {/* Calendar */}
            <div className="bg-green-900 text-white p-6 rounded-2xl shadow-lg flex flex-col items-center justify-center">
              <div className="bg-white text-green-900 px-6 py-4 rounded-2xl shadow-lg text-center">
